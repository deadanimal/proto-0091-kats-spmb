...
export class AcClimateComponent implements OnInit, OnDestroy {
  ...
  getChart3() {
    ...
    let chart = am4core.create("chartBillPresentment3", am4charts.XYChart);
  ...
  getChart4() {
    ...
    let chart = am4core.create("chartBillPresentment4", am4charts.XYChart);
  ...
  getChart6() {
    // pie chart
    // let chart = am4core.create("chartReceipt", am4charts.XYChart);
    let chart = am4core.create("chartBillPresentment6", am4charts.PieChart);
